function CustomFileBrowser(field_name, url, type, win) {
    ...
    tinyMCE.activeEditor.windowManager.open({
        file: cmsURL,
        width: 758,  // Your dimensions may differ - toy around with them!
        height: 500,
        resizable: 'yes',
        scrollbars: 'yes',
...
tinyMCE.init({
    ...
    theme_advanced_buttons1: 'formatselect,|,bold,italic,underline,|,bullist,numlist,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,pasteword,|,fullscreen,search',
